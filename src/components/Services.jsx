    ...
    <section className="services-section" id="services">
      ...
      <div className="services-grid">
        ...
        <div className="service-card">
          ...
          <p>Je vous accompagne lors de vos déplacements hors du domicile : promenade, marché, médiathèque, exposition, activité associative…</p>
        </div>
        ...
        <div className="service-card">
          ...
          <p className="about-text">Je prends le relais auprès de votre proche pour que vous puissiez faire vos courses, aller à un rendez-vous, voir des amis, pratiquer une activité ou tout simplement avoir du temps pour vous.</p>
        </div>
      </div>
    </section>
  );
